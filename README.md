...
### <a name="example">Пример</a>
В конце приведём пример, как нужно заполнять текстовые поля программы. Если мы используем структуру, представленную в данном репозитории, то текстовые поля должны быть заполнены следующим образом:
<p align="center">
  <img src="https://github.com/AlekseiRodionov/Synthetic_segmentation/blob/main/images/test.jpg?raw=true" />
</p>
